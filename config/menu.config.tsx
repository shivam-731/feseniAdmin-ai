...
export const MENU_SIDEBAR: MenuConfig = [
  { heading: 'Management' },
    ...
    { title: 'Consumers', icon: Users, path: '/admin/consumers' },
    { title: 'Billing', icon: FileText, path: '/admin/billing' },
    { title: 'Website Management', icon: Globe, path: '/admin/website-management' },
